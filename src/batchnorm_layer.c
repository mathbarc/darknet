...
layer make_batchnorm_layer(int batch, int w, int h, int c, int train)
{
    ...
    CHECK_CUDNN(cudnnSetTensor4dDescriptor(
        layer.normDstTensorDesc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, layer.batch,
...
void resize_batchnorm_layer(layer* l, int w, int h)
{
    ...
    CHECK_CUDNN(cudnnSetTensor4dDescriptor(
        l->normDstTensorDesc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, l->batch,
...
void forward_batchnorm_layer_gpu(layer l, network_state state)
{
    ...
    if (state.train) {
        ...
        if (l.batch_normalize == 2) {
            ...
            // fast_v_gpu(l.output_gpu, l.mean_gpu, l.batch, l.out_c, l.out_h*l.out_w,
            // l.v_cbn_gpu);
            ...
            fast_v_cbn_gpu(l.output_gpu, l.mean_gpu, l.batch, l.out_c, l.out_h * l.out_w, minibatch_index, max_minibatch_index, l.m_cbn_avg_gpu, l.v_cbn_avg_gpu, l.variance_gpu, alpha, l.rolling_mean_gpu, l.rolling_variance_gpu, inverse_variance, .00001);
            ...
            cudnnBatchNormalizationForwardTraining(
                cudnn_handle(), CUDNN_BATCHNORM_SPATIAL, &one, &zero,
                l.normDstTensorDesc,
                l.x_gpu, // input
                l.normDstTensorDesc,
                l.output_gpu, // output

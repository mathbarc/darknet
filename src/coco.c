...
void run_coco(int argc, char** argv)
{
    ...
    if (0 == strcmp(argv[2], "test"))
        ...
        demo(cfg, weights, thresh, hier_thresh, cam_index, filename, coco_classes, 80, 1, frame_skip, prefix, out_filename, mjpeg_port, 0, json_port, dont_show, ext_output, 0, 0, 0, 0, 0, json_file_output);
}
